...
public class Mob {
    ...
    public int zoneBoss;
    public int ninjaId;
    public boolean removeCallMob = false;
    public long timeRemoveCallMob = -1;
    ...
    public static int EXPMobX(short level) {
      if (level >= 100) {
         return 2;
      } else if (level >= 90) {
         return 3;
    ...
    public boolean isCallMob() {
        return templates.id == 230;
    }
