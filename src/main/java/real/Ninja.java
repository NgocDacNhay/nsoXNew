...
public class Ninja extends Body implements TeamBattle, IGlobalBattler {
    ...
    public int useTathu;
    public byte reward10,reward20,reward30,reward40,reward50,reward60,reward70,reward80,reward90,reward100;
    ...
    public short[] setThoiTrang;
    public int[] taskDanhVong = new int[]{-1, -1, -1, 0, -1, 20};
    ...
    public int diemHD = 0;
    public int topco4la = 0;
    public int quavip = -1;
    public int nap = 0;
    public int topthiep = 0;
    public int topmanh = 0;
    public int tayKN = 0;
    public int tayTN = 0;
    public int pointTinhTu = 0;
    public boolean giftTop = false;
    public long delayaddParty;
    public int masterId = 0;
    public long delayviewInfoPlayers = 0;
    public long delay161 = 0;
    ...
    public int Time2H = 0;
    public boolean isGift2H = false;
    public boolean isGiftLv30 = false;
    @Nullable
    ...
    @NotNull
    public int timeEndDun = 0;
    @NotNull
    public int dunId = -1;
    public boolean isInDun = false;
    public int mapKanata = 1;
    private Dun dun;
    public int limitShinwa = 10;
    //Event
    public boolean event1_isNhanQuaCayThongNoel = true;
    public int event1_pointCayThongNoel = 0;
    public int event1_pointBossTuanLoc = 0;
    ...
    public void setTimeKickSession() {
        timeKickSession = System.currentTimeMillis() + 600000L;
    }
                ...
                if (red != null && red.first()) {
                    ...
                    if (jar != null) {
                        for (byte j = 0; j < jar.size(); ++j) {
                            ...
                            ThoiTrang.setThoiTrang(nj, nj.ItemBody[index].id);
                        }
                    }
                    ...
                    if (jar != null) {
                        for (byte j = 0; j < jar.size(); ++j) {
                            ...
                            ThoiTrang.setThoiTrang(nj, nj.ItemMounts[index].id);
                        }
                    }
                    ...
                    nj.taskDanhVong[5] = Integer.parseInt(jar.get(5).toString());
                    nj.isTaskDanhVong = nj.taskDanhVong[3];
                    nj.countTaskDanhVong = nj.taskDanhVong[5];
                    ...
                    jar = (JSONArray) JSONValue.parse(red.getString("njaData_point"));
                    nj.tayKN = Integer.parseInt(jar.get(0).toString());
                    nj.tayTN = Integer.parseInt(jar.get(1).toString());
                    nj.get().setKyNangSo(Integer.parseInt(jar.get(2).toString()));
                    nj.get().setTiemNangSo(Integer.parseInt(jar.get(3).toString()));
                    nj.get().setBanghoa(Integer.parseInt(jar.get(4).toString()));
                    nj.get().setPhongLoi(Integer.parseInt(jar.get(5).toString()));
                    nj.taThuCount = Integer.parseInt(jar.get(6).toString());
                    nj.nvhnCount = Integer.parseInt(jar.get(7).toString());
                    nj.useTathu = Integer.parseInt(jar.get(8).toString());
                    nj.useDanhVongPhu = Integer.parseInt(jar.get(9).toString());
                    try {
                    ...
                    try {
                        ...
                        System.out.print("Send Effect Ninja");
                    }
                    try {
                    ...
                    jar = (JSONArray) JSONValue.parse(red.getString("nhanQuaByTime"));
                    nj.timeOnline = Integer.parseInt(jar.get(0).toString());
                    nj.Time2H = Integer.parseInt(jar.get(1).toString());
                    nj.isGift2H = Boolean.parseBoolean(jar.get(2).toString());
                    nj.isGiftLv30 = Boolean.parseBoolean(jar.get(3).toString());
                    ...
                    nj.typeEvent = red.getInt("typeEvent");
                    nj.limitShinwa = red.getInt("limitShinwa");
                    
                    //Event1
                    nj.topco4la =  red.getInt("topco4la");   
                    nj.topthiep =  red.getInt("topthiep");   
                    nj.topmanh = red.getInt("topmanh");
                    nj.quavip =  red.getInt("quavip"); 
                    nj.nap = red.getInt("nap");
                    nj.event1_isNhanQuaCayThongNoel = red.getBoolean("event1_isNhanQuaCayThongNoel");
                    nj.event1_pointCayThongNoel = red.getInt("event1_pointCayThongNoel");
                    nj.event1_pointBossTuanLoc = red.getInt("event1_pointBossTuanLoc");
                    
                    jar = (JSONArray) JSONValue.parse(red.getString("rewardLevel"));
                    nj.reward10 = Byte.parseByte(jar.get(0).toString());
                    nj.reward20 = Byte.parseByte(jar.get(1).toString());
                    nj.reward30 = Byte.parseByte(jar.get(2).toString());
                    nj.reward40 = Byte.parseByte(jar.get(3).toString());
                    nj.reward50 = Byte.parseByte(jar.get(4).toString());
                    nj.reward60 = Byte.parseByte(jar.get(5).toString());
                    nj.reward70 = Byte.parseByte(jar.get(6).toString());
                    nj.reward80 = Byte.parseByte(jar.get(7).toString());
                    nj.reward90 = Byte.parseByte(jar.get(8).toString());
                    nj.reward100 = Byte.parseByte(jar.get(9).toString());

                    nj.giftTop = red.getBoolean("giftTop");
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    public void flush() {
        ...
        try {
            ...
            jarr.add(this.tayKN);
            jarr.add(this.tayTN);
            jarr.add(this.getKyNangSo());
            jarr.add(this.getTiemNangSo());
            jarr.add(this.getBanghoa());
            jarr.add(this.getPhongLoi());
            jarr.add(this.taThuCount);
            jarr.add(this.nvhnCount);
            jarr.add(this.useTathu);
            jarr.add(this.useDanhVongPhu);
            sqlSET = sqlSET + ",`njaData_point`='" + jarr.toJSONString() + "'";
            jarr.clear();
            
            jarr.add(this.timeOnline);
            jarr.add(this.Time2H);
            jarr.add(this.isGift2H);
            jarr.add(this.isGiftLv30);
            sqlSET = sqlSET + ",`nhanQuaByTime`='" + jarr.toJSONString() + "'";
            jarr.clear();
            ...
            sqlSET = sqlSET + ", `giftTop`=" + giftTop + "";
            sqlSET = sqlSET + ", `typeEvent`=" + typeEvent + "";
            sqlSET = sqlSET + ", `limitShinwa`=" + limitShinwa + "";
            //Event1
            sqlSET = sqlSET + ", `event1_isNhanQuaCayThongNoel`=" + event1_isNhanQuaCayThongNoel + ", `event1_pointCayThongNoel`=" + event1_pointCayThongNoel + ",`event1_pointBossTuanLoc`=" + event1_pointBossTuanLoc + "";
            sqlSET = sqlSET + ", `topco4la`=" + topco4la + "";
            sqlSET = sqlSET + ", `topthiep`=" + topthiep + "";
            sqlSET = sqlSET + ", `topmanh`=" + topmanh + "";
            sqlSET = sqlSET + ", `quavip`=" + quavip + "";
            sqlSET = sqlSET + ", `nap`=" + nap + "";
    ...
    public void removeAllItemInBag(int itemId) {
        if (itemId != -1) {
            for (int i = 0; i < ItemBag.length; i++) {
                Item item = ItemBag[i];
                if (item != null && (item.id == itemId || item.getData().isItemNhiemVu()) && item.id != 743) {
                    ItemBag[i] = null;
                }
            }
        }
